...
const academic: ModeTheme = {
  light: {
    ...
    textarea:
      'border-neutral-300 bg-white text-neutral-900 placeholder:text-neutral-400 focus:border-blue-500 focus:ring-blue-500',
...
const flirt: ModeTheme = {
  light: {
    ...
    textarea:
      'border-rose-200 bg-white text-neutral-900 placeholder:text-neutral-400 focus:border-rose-400 focus:ring-rose-400',
...
const roast: ModeTheme = {
  light: {
    ...
    textarea:
      'border-orange-200 bg-white text-neutral-900 placeholder:text-neutral-400 focus:border-orange-500 focus:ring-orange-400',
