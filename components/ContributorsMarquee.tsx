...
const CONTRIBUTORS: Contributor[] = [
    { name: 'Dusti Johnson', linkedin: 'https://www.linkedin.com/in/dusti-johnson/' },
    { name: 'Sapnish Sharma', linkedin: 'https://www.linkedin.com/in/sapnish-sharma-7107a9280/' },
    { name: 'Rajdeep Sah', linkedin: 'https://www.linkedin.com/in/rajdeepsah/' },
    { name: 'Ari Lee', linkedin: 'https://www.linkedin.com/in/moonyoung-lee-565043342/?locale=en' },
    { name: 'Ujjwal Sitaula', linkedin: 'https://www.linkedin.com/in/ujjwalsitaula839/' },
];
    ...
    return (
        ...
        >
            ...
            <div
                ...
                onMouseEnter={(e) =>
                ((e.currentTarget.firstChild as HTMLElement).style.animationPlayState =
                    'paused')
                }
                onMouseLeave={(e) =>
                ((e.currentTarget.firstChild as HTMLElement).style.animationPlayState =
